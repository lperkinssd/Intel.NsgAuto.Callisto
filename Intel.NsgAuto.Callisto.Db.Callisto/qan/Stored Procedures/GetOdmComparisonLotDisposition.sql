...
-- EXEC [qan].[GetOdmComparisonLotDisposition] 'jakemurx', 84
-- =============================================
CREATE PROCEDURE [qan].[GetOdmComparisonLotDisposition] 
...
BEGIN
	...
	(
		...
		FROM [qan].[OdmQualFilters] nqm WITH (NOLOCK)
			...
			LEFT JOIN [qan].[OdmQualFilterLotDispositions] ld  WITH (NOLOCK)
