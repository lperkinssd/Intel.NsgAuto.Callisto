-- ===================================================================================================================================
-- Author       : bricschx
-- Create date  : 2020-12-21 13:19:02.637
-- Description  : Rejects an mm recipe and returns all data needed for the details view
-- Example      : DECLARE @Message VARCHAR(500);
--                EXEC [qan].[UpdateMMRecipeRejectedReturnDetails] NULL, @Message OUTPUT, 'bricschx', 0, 0, 'Test comment';
--                PRINT @Message; -- should print: 'Invalid mm recipe: 0'
-- ===================================================================================================================================
CREATE PROCEDURE [qan].[UpdateMMRecipeRejectedReturnDetails]
(
...
BEGIN
	...
	EXEC [qan].[UpdateMMRecipeRejected] @Succeeded OUTPUT, @Message OUTPUT, @EmailBatchId OUTPUT, @UserId, @Id, @SnapshotReviewerId, @Comment, @Override;
