...
-- Description  : Cancels an auto checker build criteria and returns all data needed for the details view
-- Example      : DECLARE @Message VARCHAR(500);
--                EXEC [qan].[UpdateAcBuildCriteriaCanceledReturnDetails] NULL, @Message OUTPUT, 'bricschx', 0;
--                PRINT @Message; -- should print: 'Invalid build criteria: 0'
-- ===============================================================================================================
CREATE PROCEDURE [qan].[UpdateAcBuildCriteriaCanceledReturnDetails]
(
...
BEGIN
	...
	EXEC [qan].[UpdateAcBuildCriteriaCanceled] @Succeeded OUTPUT, @Message OUTPUT, @EmailBatchId OUTPUT, @UserId, @Id, @Override;
