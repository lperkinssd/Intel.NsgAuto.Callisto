-- ====================================================================================================================
-- Author       : bricschx
-- Create date  : 2021-03-04 14:28:44.650
-- Description  : Cancels an osat build criteria set and returns all data needed for the details view
-- Example      : DECLARE @Message VARCHAR(500);
--                EXEC [qan].[UpdateOsatBuildCriteriaSetCanceledReturnDetails] NULL, @Message OUTPUT, 'bricschx', 0;
--                PRINT @Message; -- should print: 'Invalid build criteria set: 0'
-- ====================================================================================================================
CREATE PROCEDURE [qan].[UpdateOsatBuildCriteriaSetCanceledReturnDetails]
(
...
BEGIN
	...
	EXEC [qan].[UpdateOsatBuildCriteriaSetCanceled] @Succeeded OUTPUT, @Message OUTPUT, @EmailBatchId OUTPUT, @UserId, @Id, @Override;
