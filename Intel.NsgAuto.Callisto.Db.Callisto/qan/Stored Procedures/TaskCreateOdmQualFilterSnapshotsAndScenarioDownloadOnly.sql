...
-- Example     : EXEC [qan].[TaskCreateOdmQualFilterSnapshotsAndScenarioDownloadOnly];
-- ============================================================================
CREATE PROCEDURE [qan].[TaskCreateOdmQualFilterSnapshotsAndScenarioDownloadOnly]
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN TRY
		...
		EXEC [CallistoCommon].[stage].[CreateTaskByName] @TaskId OUTPUT, 'Create ODM QF Snapshots And Scenario DownloadOnly';
