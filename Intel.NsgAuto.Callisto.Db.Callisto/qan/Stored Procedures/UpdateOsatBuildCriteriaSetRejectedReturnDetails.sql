-- ========================================================================================================================================
-- Author       : bricschx
-- Create date  : 2021-03-04 14:22:42.110
-- Description  : Rejects an osat build criteria set and returns all data needed for the details view
-- Example      : DECLARE @Message VARCHAR(500);
--                EXEC [qan].[UpdateOsatBuildCriteriaSetRejectedReturnDetails] NULL, @Message OUTPUT, 'bricschx', 0, 0, 'Test comment';
--                PRINT @Message; -- should print: 'Invalid build criteria set: 0'
-- ========================================================================================================================================
CREATE PROCEDURE [qan].[UpdateOsatBuildCriteriaSetRejectedReturnDetails]
(
...
BEGIN
	...
	EXEC [qan].[UpdateOsatBuildCriteriaSetRejected] @Succeeded OUTPUT, @Message OUTPUT, @EmailBatchId OUTPUT, @UserId, @Id, @SnapshotReviewerId, @Comment, @Override;
