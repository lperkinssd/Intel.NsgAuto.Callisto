-- ===============================================================================
-- Author       : bricschx
-- Create date  : 2020-09-24 15:52:49.220
-- Description  : Submits a product label version
-- Example      : EXEC [qan].[UpdateProductLabelSetVersionSubmitted] 'bricschx', 1
-- ===============================================================================
CREATE PROCEDURE [qan].[UpdateProductLabelSetVersionSubmitted]
(
	  @UserId VARCHAR(25)
	, @Id INT
	, @Override BIT = NULL
