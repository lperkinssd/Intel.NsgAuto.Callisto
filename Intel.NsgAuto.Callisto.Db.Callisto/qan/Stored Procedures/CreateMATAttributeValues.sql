...
--              EXEC [qan].[CreateMATAttributeValues] 1, 2, '7.77/7.82/7.83', 'jakemurx', '2020-09-28 23:42:18.5866667'
...
-- =============================================
CREATE PROCEDURE [qan].[CreateMATAttributeValues] 
...
BEGIN
	...
	BEGIN
		...
		SET @DataType = [qan].[GetMATDataTypeFromValue](@AttributeValue)
	...
	INSERT INTO [qan].[MATAttributeValues]
	(
		 [MATId]
		,[AttributeTypeId]
		,[Value]
