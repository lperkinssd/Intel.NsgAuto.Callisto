-- ===============================================================================================================
-- Author       : bricschx
-- Create date  : 2020-12-07 10:28:10.400
-- Description  : Gets auto checker build criteria reviewers
-- Example      : SELECT * FROM [qan].[FAcBuildCriteriaReviewers](NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
-- ===============================================================================================================
CREATE FUNCTION [qan].[FAcBuildCriteriaReviewers]
(
	  @Id BIGINT = NULL
...
(
	SELECT
		...
		, R.[Wwid]
		, R.[Email]
	FROM [qan].[AcBuildCriteriaReviewers] AS R WITH (NOLOCK)
