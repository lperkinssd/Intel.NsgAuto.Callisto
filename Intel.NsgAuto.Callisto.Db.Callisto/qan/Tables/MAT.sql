CREATE TABLE [qan].[MAT] (
    ...
    [CreatedOn]                    DATETIME2 (7) CONSTRAINT [DF_MAT_CreatedOn] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]                    VARCHAR (50)  NULL,
    [UpdatedOn]                    DATETIME2 (7) CONSTRAINT [DF_MAT_UpdatedOn] DEFAULT (getutcdate()) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_MAT_Latest]
    ON [qan].[MAT]([Latest] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_MAT]
    ON [qan].[MAT]([MatVersion] DESC);
