...
-- SELECT [npsg].[FParseMATAttributes](NULL)
-- SELECT [npsg].[FParseMATAttributes]('NULL')
-- SELECT [npsg].[FParseMATAttributes]('WAVE019')
-- SELECT [npsg].[FParseMATAttributes]('N38A00 N A')
-- SELECT [npsg].[FParseMATAttributes]('7.77/7.82/7.83')
-- SELECT [npsg].[FParseMATAttributes]('PRB_06/PRB 06/PRB_08/PRB 08/PRB_10/PRB 10/PRB_14/PRB 14/PRB_15/PRB 15')
-- SELECT [npsg].[FParseMATAttributes]('>=121')
-- SELECT [npsg].[FParseMATAttributes]('=121')
-- =============================================
CREATE FUNCTION [npsg].[FParseMATAttributes] 
(
