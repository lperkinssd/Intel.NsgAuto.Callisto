CREATE TABLE [npsg].[OdmLotShipSnapshotsHistory] (
...
GO
CREATE NONCLUSTERED INDEX [IX_NPSG_OdmLotShipSnapshotsHistory]
    ON [npsg].[OdmLotShipSnapshotsHistory]([Version] DESC);
