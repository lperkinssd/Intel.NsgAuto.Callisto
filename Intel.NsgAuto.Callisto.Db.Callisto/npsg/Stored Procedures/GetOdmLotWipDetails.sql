...
-- EXEC [npsg].[GetOdmLotWipDetails]  'S051E22I', NULL, NULL, NULL, 'jkurian'
-- =============================================
CREATE PROCEDURE [npsg].[GetOdmLotWipDetails] (
	  @SLot			VARCHAR(25)
	, @MediaIPN     VARCHAR(25)
	, @SCode		VARCHAR(25)
	, @OdmName		VARCHAR(25)
...
BEGIN
	...
	FROM [TREADSTONENPSGPRD].[treadstone].[odm].[vw_callisto_odm_wip_data] wip
	WHERE 
