...
-- ==================================================================================================================================================
-- Author       : ftianx (modified based on [npsg].[GetOdmQualFilterNonQualifiedMediaExceptions])
-- Create date  : 2021-11-03 10:58:58.698
-- Description  : Get the historical non-qualified media exceptions
-- Example      : EXEC [npsg].[GetOdmHistoricalQualFilterNonQualifiedMediaExceptions] 'fuhantx', 15
-- ==================================================================================================================================================

CREATE PROCEDURE [npsg].[GetOdmHistoricalQualFilterNonQualifiedMediaExceptions] 
	@UserId varchar(25), 
	@Id int
AS
BEGIN
	...
	SELECT [ScenarioId]
		  ...
		  ,[SLot]
	FROM [npsg].[OdmQualFiltersHistory]
	WHERE [ScenarioId] = @Id
