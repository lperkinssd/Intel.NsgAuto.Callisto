...
{
    public class ProductOwnershipsController : LayoutController
    {
        // GET: ProductOwnerships
        public ActionResult Index()
        {
            ProductOwnershipsModel model = null;
            try
            {
                // create the model with layout
                model = CreateLayout(new ProductOwnershipsModel());
            ...
            catch (Exception ex)
            {
                ...
                Log.Error("Product Ownership Index Method ", ex);
                throw ex;
            }
            finally
            {
