...
namespace Intel.NsgAuto.Callisto.Business.Logging
{
    public  class Log
    {
        ...
        /// 
        /// </summary>
        /// <param name="exception"></param>The exception to log, including its stack trace </param>  
        public static void Error(System.Exception exception)
        {
            _instance.monitoringLogger.Error(exception);
        }
        /// <summary>  
        ///  
        /// </summary>  
