...
{
    public class OdmIogDataContext : OdmDataContext, IOdmIogDataContext
    {
        ...
        public MatVersions GetMatVersionDetails(string userId, int versionId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMMATVERSIONDETAILS);
        ...
        public ImportVersions GetMatVersions(string userId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMMATVERSIONS);
                dataAccess.AddInputParameter("@UserId", userId);
                using (IDataReader reader = dataAccess.ExecuteReader())
                {
                    while (reader.Read())
        ...
        public ImportResult Import(string userId, MatRecords records)
        {
            ...
            try
            {
                ...
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_IMPORTMATRECORDS);
                dataAccess.AddInputParameter("@UserId", userId);
                dataAccess.AddTableValueParameter("@MatRecords", UserDefinedTypes.MATRECORDS, createTableImport(records));
        ...
        public DispositionVersions GetDispositionVersions(string userId)
        {
            ...
            try
            {
                ...
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMMANUALDISPOSITIONSVERSIONS);
                dataAccess.AddInputParameter("@UserId", userId);
                using (IDataReader reader = dataAccess.ExecuteReader())
                {
                    while (reader.Read())
            ...
            try
            {
                ...
                if (response.Succeeded)
                {
                    ...
                    try
                    {
                        ...
                        dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_IMPORTODMMANUALDISPOSITIONS);
                        dataAccess.AddInputParameter("@UserId", userId);
                        dataAccess.AddTableValueParameter("@OdmManualDispositions", UserDefinedTypes.ODMMANUALDISPOSITIONS, createDispositionsImportTable(response.Dispositions));
                        using (IDataReader reader = dataAccess.ExecuteReader())
                        {
        ...
        public Dispositions GetDispositionsByVersion(int versionId, string userId)
        {
            ...
            try
            {
                ...
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMMANUALDISPOSITIONSBYVERSION);
                dataAccess.AddInputParameter("@Version", versionId);
                dataAccess.AddInputParameter("@UserId", userId);
                using (IDataReader reader = dataAccess.ExecuteReader())
                {
        ...
        public PrfVersions GetPrfVersionDetails(string userId, int versionId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMPRFVERSIONDETAILS);
                dataAccess.AddInputParameter("@UserId", userId);
        ...
        public ImportVersions GetPrfVersions(string userId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMPRFVERSIONS);
                dataAccess.AddInputParameter("@UserId", userId);
                using (IDataReader reader = dataAccess.ExecuteReader())
                {
                    while (reader.Read())
        ...
        public ImportResult Import(string userId, PrfRecords records)
        {
            ...
            try
            {
                result = new ImportResult();
                result.Messages = new List<string>();
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_IMPORTPRFRECORDS);
                dataAccess.AddInputParameter("@UserId", userId);
                dataAccess.AddTableValueParameter("@PrfRecords", UserDefinedTypes.PRFRECORDS, createTableImport(records));
                dataAccess.ExecuteReader();
        ...
        public Result RunQualFilter(string userId)
        {
            ...
            try
            {
                ...
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTER);
                dataAccess.AddInputParameter("@UserId", userId);
                ...
                foreach (var odmName in odmNames)
                {
                    ...
                    string odmLocalPath = String.Format(Settings.ODMFilterOutputPathOptane, odmName);
                    // If the directory does not exist, create it
                    if (!Directory.Exists(odmLocalPath))
                    {
                        Directory.CreateDirectory(odmLocalPath);
                    }
                    nonQualifiedPartsFile = Path.Combine(odmLocalPath + @"\ODM_Non-Qualified_Media_FilterReport_IOG_" + odmName + "_" + utcTimeStamp + ".csv");
                    exemptPartsFile = Path.Combine(odmLocalPath + @"\ODM_Qualified_Media_FilterReport_IOG_" + odmName + "_" + utcTimeStamp + ".csv");
                    ...
                    if (EmailHelper.Send(files, Settings.GetOdmEmailRecipients(odmName, "OPTANE"), "OPTANE", odmName))
                    {
                        //Logger.Info($"Sent emails for {odmName}");
                    }
                    // Post files to FTP for the ODM
                    //PostToFTPLocation();
                    string odmPath = String.Format(Settings.FTPLocation, "Optane", odmName);
        ...
        public Result SaveLotDispositions(string userId, LotDispositions lotDispositions)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_SAVELOTDISPOSITIONS);
                dataAccess.AddInputParameter("@userId", userId.NullToDBNull());
                dataAccess.AddTableValueParameter("@lotDispositions", UserDefinedTypes.ODMLOTDISPOSITIONS, dtLotDispositions);
        ...
        public Result CreateLotDisposition(string userId, LotDispositionDto lotDisposition)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_CREATEODMQUALFILTERLOTDISPOSITION);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
        ...
        public LotDispositionActions GetLotDispositionActions(string userId, int? id = null)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMLOTDISPOSITIONACTIONS);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
        ...
        public IdAndNames GetLotDispositionReasons(string userId, int? id = null)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMLOTDISPOSITIONREASONS);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.AddInputParameter("@Id", id.NullToDBNull());
        ...
        {
            return base.GetQualFilterRemovableSLotUploads(userId, loadToDate, StoredProcedures.SP_GETQUALFILTERIOGREMOVABLESLOTUPLOADS);
        }
        ...
        private QualFilterScenario getQualFilterScenario(string userId, int versionId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTERSCENARIO);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
        ...
        private QualFilterScenario getQualFilterHistoricalScenario(string userId, int versionId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTERHISTORICALSCENARIO);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.AddInputParameter("@Id", versionId.NullToDBNull());
                dataAccess.SetTimeout(5 * 60);
        ...
        private QualFilterScenarioVersions getQualFilterScenarioVersions(string userId, int? id = null, int? prfVersion = null, int? matVersion = null, int? odmWipSnapshotVersion = null, int? lotShipSnapshotVersion = null, int? lotDispositionSnapshotVersion = null)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTERSCENARIOVERSIONS);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.AddInputParameter("@Id", id.NullToDBNull());
        ...
        private QualFilterScenarioVersions getQualFilterScenarioVersionsDaily(string userId, int? id = null, int? prfVersion = null, int? matVersion = null, int? odmWipSnapshotVersion = null, int? lotShipSnapshotVersion = null, int? lotDispositionSnapshotVersion = null)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTERSCENARIOVERSIONSDAILY);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.AddInputParameter("@Id", id.NullToDBNull());
                dataAccess.AddInputParameter("@PrfVersion", prfVersion.NullToDBNull());
                dataAccess.AddInputParameter("@MatVersion", matVersion.NullToDBNull());
        ...
        private QualFilterScenarioVersions getQualFilterScenarioHistoricalVersions(string userId, int? id = null, int? prfVersion = null, int? matVersion = null, int? odmWipSnapshotVersion = null, int? lotShipSnapshotVersion = null, int? lotDispositionSnapshotVersion = null)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTERSCENARIOHISTORICALVERSIONS);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.AddInputParameter("@Id", id.NullToDBNull());
                dataAccess.AddInputParameter("@PrfVersion", prfVersion.NullToDBNull());
                dataAccess.AddInputParameter("@MatVersion", matVersion.NullToDBNull());
        ...
        public Result PublishScenario(string userId, int? versionId)
        {
            ...
            try
            {
                ...
                //Logger.Info($"Entering RunQualFilter as {userId}");
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_PUBLISHODMQUALFILTER);
                dataAccess.AddInputParameter("@UserId", userId);
        ...
        {
            base.ProcessRemovableSLots(userId, StoredProcedures.SP_TASKPROCESSIOGREMOVABLESLOTS, Settings.OdmSLotIOGPickupLocation, "IOG");
        }

        public QualFilterRemovableSLots GetRemovableSLotDetails(string userId, int version, string odmName)
        {
            return base.GetRemovableSLotDetails(userId, version, odmName, StoredProcedures.SP_GETIOGREMOVABLESLOTSDETAILS);
        }

        public string GetProhibitedTimeRanges(string userId)
        {
            return base.GetProhibitedTimeRanges(userId, "Optane");
        }

        public CheckProhibitedScenarioRunTimeResponse CheckProhibitedScenarioRunTime(string userId)
        {
            return base.CheckProhibitedScenarioRunTime(userId, "Optane");
        }
        ...
        public OdmWips GetOdmLotWipDetails(string sLot, string mediaIPN, string sCode, string odmName, string userId)
        {
            ...
            try
            {
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMLOTWIPDETAILS);
        ...
        public ExplainabilityReport GetExplainabilityReport(string userId)
        {
            ...
            try
            {
                ...
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_GETODMQUALFILTEREXPLANATIONS);
                dataAccess.AddInputParameter("@UserId", userId);
        ...
        private RunScenarioResponse createQualFilterScenario(string userId)
        {
            ...
            {
                response = new RunScenarioResponse();
                dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoConnectionString, StoredProcedures.SP_RUNODMQUALFILTERSCENARIO);
                dataAccess.AddInputParameter("@UserId", userId.NullToDBNull());
                dataAccess.SetTimeout(300);
        ...
        private Dispositions getAll(string userId, int? id = null, bool? isActive = null, bool? isPOR = null)
        {
            ...
            try
            {
                //dataAccess = new DataAccessFactory().CreateSqlDataAccess(Settings.CallistoCommonConnectionString, StoredProcedures.SP_GETDISPOSITIONS);
                //dataAccess.AddInputParameter("@UserId", userId);
                //dataAccess.AddInputParameter("@Id", id.NullToDBNull());
